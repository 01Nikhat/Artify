...
//   return (
//     <div className='flex items-center justify-between py-4'>
//       <Link to="/BgRemoval"><img src={assets.logo} alt="" className='w-28 sm:w-32 lg:w-40'/></Link>
...
//               onClick={() => navigate('/bgResult')}
//             >
//               BG Removal <img className='w-3 sm:w-4' src={assets.arrow_icon} alt="" />
//             </button>
//           </div>
//           <button 
