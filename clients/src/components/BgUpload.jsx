    ...
    <div className='pb-16'>
      ...
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent py-6 md:py-16'>See the magic. Try Now</h1>
       ...
       <div className='text-center mb-24'>
                ...
                <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-700 to-fuchsia-200 m-auto hover:scale-105 transition-all duration-700' htmlFor="upload2">
