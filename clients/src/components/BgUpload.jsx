  ...
  return (
    <div className="pb-16">
      ...
      <div className="text-center mb-24">
        ...
        />
        <label
          className={`inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-700 to-fuchsia-800 m-auto transition-all duration-700 ${
            isProcessing ? "opacity-75 cursor-not-allowed" : "hover:scale-105"
          }`}
          htmlFor="upload2"
        >
          <img width={20} src={assets.upload_btn_icon || "/placeholder.svg"} alt="" />
