...
//             />
//             <label
//               className={`inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-700 hover:from-violet-700 hover:to-fuchsia-800 transition-all duration-300 ${isProcessing ? "opacity-75 cursor-not-allowed" : "hover:scale-105"}`}
//               htmlFor="upload1"
//             >
//               <p className="text-white text-sm">{isProcessing ? "Processing..." : "Upload your image"}</p>
//             </label>
//           </div>
//         </div>
//         {/* ---------------Right Side-----------*/}
...
const BgHeader = () => {
  ...
  return (
    <div className="relative w-screen overflow-hidden">
      ...
      {/* Content wrapper */}
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 lg:px-12 xl:px-24 py-12 lg:py-24 min-h-[calc(100vh-72px)]">
        {/* ---------------Left Side-----------*/}
