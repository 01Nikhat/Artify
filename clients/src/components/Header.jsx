...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
      ...
      <h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-8 text-center'>Turn text to <span className='text-blue-600'>image</span>, in seconds.</h1>
